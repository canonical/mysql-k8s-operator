...
For more background about Juju upgrades in the context of database charms, check  [Explanation > Juju > Juju upgrades](/t/11984#heading--upgrades).
...
# wait until complete
```
Once the model has finished upgrading, you can proceed with the [charm upgrade](/t/11752).
...
You can now proceed with the [charm upgrade](/t/11752).

<a href="#heading--resources"><h2 id="heading--resources"> Resources </h2></a>
Further documentation about Juju upgrades: 
* [MySQL K8s | Explanation > Juju > Juju upgrades](/t/11984#heading--upgrades)
