...
html_context = {
    ...
    "product_page": "canonical.com/data/mysql",
    ...
    "github_url": "https://github.com/canonical/mysql-k8s-operator",
...
#
html_theme_options = {
'source_edit_link': 'https://github.com/canonical/mysql-k8s-operator',
}
...
html_baseurl = 'https://canonical-charmed-mysql-k8s.readthedocs-hosted.com/'
...
# Enables MyST references via standard anchors
