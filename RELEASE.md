...
At any given time there are three revisions of the MySQL charm [available on CharmHub.io](https://charmhub.io/mysql-k8s), for each of the following channels:
...
Currently, the MySQL charm does not make use of the `latest/beta` channel.
